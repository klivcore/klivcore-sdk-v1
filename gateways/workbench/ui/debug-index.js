...
var publishedScenarioIdsByCategory = Object.freeze({
  "bench-viewport": Object.freeze(["rgb-squares", "textareas", "comments", "agent-quick-access", "comment-parenting", "lod-validation", "stress-1k", "stress-10k", "stress-100k", "stress-1m", "stress-textareas-1k", "stress-textareas-10k", "stress-textareas-100k"])
});
...
function mount(host, createDebugRoot = import_client.createRoot) {
  const container = host.root.ownerDocument.createElement("div");
  container.setAttribute("data-workbench-debug-index", "root");
  host.root.append(container);
  let root2;
  try {
    root2 = createDebugRoot(container);
    const routeHref = globalThis.location.pathname.replace(/\/$/u, "");
    root2.render(/* @__PURE__ */ jsx_runtime.jsx("main", {
      className: "min-h-screen bg-slate-950 px-6 py-10 text-slate-100",
      children: /* @__PURE__ */ jsx_runtime.jsxs("section", {
        className: "mx-auto max-w-5xl space-y-8",
        children: [
          /* @__PURE__ */ jsx_runtime.jsx("a", {
            className: "text-sm text-cyan-300 hover:text-cyan-200",
            href: routeHref.slice(0, -"/debug".length),
            children: "← Workbench"
          }),
          /* @__PURE__ */ jsx_runtime.jsxs("div", {
            children: [
              ...
              /* @__PURE__ */ jsx_runtime.jsx("p", {
                ...
                children: "Published package-owned debug categories."
              })
            ]
          }),
          /* @__PURE__ */ jsx_runtime.jsx("div", {
            className: "grid gap-4 md:grid-cols-2",
            children: publishedWorkbenchDebugContributions.map((contribution) => /* @__PURE__ */ jsx_runtime.jsxs("a", {
              className: "rounded-xl border border-slate-700 bg-slate-900 p-5 hover:border-cyan-400",
              href: `${routeHref}/${contribution.debugId}`,
              children: [
                ...
                /* @__PURE__ */ jsx_runtime.jsxs("p", {
                  className: "mt-3 text-xs font-semibold uppercase tracking-wide text-cyan-300",
                  children: [
                    contribution.scenarioIds.length,
                    " published scenario",
                    contribution.scenarioIds.length === 1 ? "" : "s"
                  ]
                })
              ]
            }, contribution.debugId))
          })
        ]
      })
    }));
