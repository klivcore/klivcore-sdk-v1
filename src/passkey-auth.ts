...
:root{color-scheme:light;--realm-ink:#14202b;--realm-muted:#667381;--realm-line:#d9e0e6;--realm-surface:#fff;--realm-canvas:#07090d;--realm-canvas-ink:#e9edf3;--realm-canvas-muted:#8f99a8;--realm-canvas-line:#232833;--realm-accent:#137a92;--realm-accent-hover:#0d6074;font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}
